...
import ProductTemp from "./productTemp2";
...
import ImageComponent from "./test";
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `https://zkls2z-8001.csb.app/home/popular?page=${page}&clothType=${currentClothType}`
      );
    ...
    <Box sx={{ width: "100%", typography: "body1" }}>
      <TabContext value={value}>
        ...
        <TabPanel value="1">
          ...
          {products.map((product) => {
            return <ImageComponent imageData={product.thumbnail} />;
          })}
        </TabPanel>
        <TabPanel value="2">
          <TypeSelector />
